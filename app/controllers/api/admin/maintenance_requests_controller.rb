  ...
  def request_detail_json(r)
    {
      ...
      tenant: {
        id: r.tenant.id, name: r.tenant.name, email: r.tenant.email, cell_phone: r.tenant.cell_phone,
      ...
      assigned_vendor: r.assigned_vendor ? { id: r.assigned_vendor.id, name: r.assigned_vendor.name, cell_phone: r.assigned_vendor.cell_phone, vendor_type: r.assigned_vendor.vendor_type } : nil,
